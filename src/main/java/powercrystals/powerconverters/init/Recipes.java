...
public class Recipes {
	...
	public static void ModRecipes(){
		GameRegistry.addRecipe(new ItemStack(ModBlocks.converterBlockCommon, 1, 0),
				"GRG", "LDL", "GRG",
				Character.valueOf('G'), Items.gold_ingot,
				Character.valueOf('R'), Items.redstone,
				Character.valueOf('L'), Blocks.glass,
				Character.valueOf('D'), Items.diamond);
		
		GameRegistry.addRecipe(new ItemStack(ModBlocks.converterBlockCommon, 1, 2),
				"GRG", "ICI", "GRG",
				Character.valueOf('G'), Items.gold_ingot,
				Character.valueOf('R'), Items.redstone,
	...
	public static void BuildCraftRecipes(){
		try{
		GameRegistry.addRecipe(new ItemStack(ModBlocks.converterBlockBuildCraft, 1, 0),
				"G G", " E ", "G G",
				Character.valueOf('G'), Items.gold_ingot,
				Character.valueOf('E'), new ItemStack((Block)(Class.forName("buildcraft.BuildCraftEnergy").getField("engineBlock").get(null)), 1, 1));
		}catch(Exception e){
			FMLLogHelper.logException(Level.FATAL, "Found Buildcraft But Failed To Load Recipes, Mabey They Changed Their Item / Block Names?", e);
		}
		GameRegistry.addShapelessRecipe(new ItemStack(ModBlocks.converterBlockBuildCraft, 1, 1), new ItemStack(ModBlocks.converterBlockBuildCraft, 1, 0));
		GameRegistry.addShapelessRecipe(new ItemStack(ModBlocks.converterBlockBuildCraft, 1, 0), new ItemStack(ModBlocks.converterBlockBuildCraft, 1, 1));
		
	}
	
	public static void ThermalExpansionRecipes(){
		try{
		GameRegistry.addRecipe(new ItemStack(ModBlocks.converterBlockThermalExpansion, 1, 0),
	    		"G G", " E ", "G G",
	    		Character.valueOf('G'), Items.gold_ingot,
	    		Character.valueOf('E'), new ItemStack((Block) (Class.forName("thermalexpansion.block.TEBlocks").getField("blockDynamo").get(null)), 1, 1));
		}catch(Exception e){
	...
	public static void IndustrialCraft2Recipes(){
		try{
		GameRegistry.addRecipe(new ItemStack(ModBlocks.converterBlockIndustrialCraft, 1, 0),
				"G G", " T ", "G G",
				Character.valueOf('G'), Items.gold_ingot,
				Character.valueOf('T'), (ItemStack)(Class.forName("ic2.core.Ic2Items").getField("lvTransformer").get(null)));
		GameRegistry.addRecipe(new ItemStack(ModBlocks.converterBlockIndustrialCraft, 1, 2),
				"G G", " T ", "G G",
				Character.valueOf('G'), Items.gold_ingot,
				Character.valueOf('T'), (ItemStack)(Class.forName("ic2.core.Ic2Items").getField("mvTransformer").get(null)));
		GameRegistry.addRecipe(new ItemStack(ModBlocks.converterBlockIndustrialCraft, 1, 4),
				"G G", " T ", "G G",
				Character.valueOf('G'), Items.gold_ingot,
				Character.valueOf('T'), (ItemStack)(Class.forName("ic2.core.Ic2Items").getField("hvTransformer").get(null)));
		GameRegistry.addRecipe(new ItemStack(ModBlocks.converterBlockIndustrialCraft, 1, 6),
				"G G", " T ", "G G",
				Character.valueOf('G'), Items.gold_ingot,
	...
	public static void FactorizationRecipes(){
		try {
			...
			GameRegistry.addRecipe(new ItemStack(ModBlocks.converterBlockFactorization, 1, 0),
					"I I", " B ", "I I",
